...
public class LisbonSausagePizza extends Pizza {
    ...
    public LisbonSausagePizza(PizzaIngredientFactory lisbonPizzaIngredientFactory) {
        this.pizzaName = "Lisbon Sausage";
    ...
    protected void prepare() {
        ...
        System.out.println("Sausage Type: " + lisbonPizzaIngredientFactory.createSausage().getSausageType());
    }
}
